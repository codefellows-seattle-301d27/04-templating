...
Article.prototype.toHtml = function() {
  ...
  // estimate: 20min actual: 10min

  var articleTemplateString = $('#articleTemplate').html();
  var compiled = Handlebars.compile(articleTemplateString);
  ...
  // estimated time: 1 hour actual time: 1.5
